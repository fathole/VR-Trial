...
//     version 1.5.1
//     from Assets/Plugins/XR Sample/2.3.2/Starter Assets/XRI Default Input Actions.inputactions
//
...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Menu"",
                    ""type"": ""Button"",
                    ""id"": ""caae9009-0df7-4398-86f4-894f9a8f60d0"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""9b7b4b87-dc63-4a02-90a2-080c42d76a66"",
        ...
        {
            ""name"": ""TestngMap"",
            ""id"": ""2554e02f-dc07-4e34-9eb4-31ee17811d12"",
            ""actions"": [
                {
                    ""name"": ""Testing"",
                    ""type"": ""Button"",
                    ""id"": ""7a476141-24bb-42a8-9be9-aa8d3b188401"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""da981b5d-00e2-428b-809c-7cd169f83e6a"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // TestngMap
        m_TestngMap = asset.FindActionMap("TestngMap", throwIfNotFound: true);
        m_TestngMap_Testing = m_TestngMap.FindAction("Testing", throwIfNotFound: true);
    }
    ...
    // TestngMap
    private readonly InputActionMap m_TestngMap;
    private List<ITestngMapActions> m_TestngMapActionsCallbackInterfaces = new List<ITestngMapActions>();
    private readonly InputAction m_TestngMap_Testing;
    public struct TestngMapActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public TestngMapActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @Testing => m_Wrapper.m_TestngMap_Testing;
        public InputActionMap Get() { return m_Wrapper.m_TestngMap; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(TestngMapActions set) { return set.Get(); }
        public void AddCallbacks(ITestngMapActions instance)
        {
            if (instance == null || m_Wrapper.m_TestngMapActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_TestngMapActionsCallbackInterfaces.Add(instance);
            @Testing.started += instance.OnTesting;
            @Testing.performed += instance.OnTesting;
            @Testing.canceled += instance.OnTesting;
        }

        private void UnregisterCallbacks(ITestngMapActions instance)
        {
            @Testing.started -= instance.OnTesting;
            @Testing.performed -= instance.OnTesting;
            @Testing.canceled -= instance.OnTesting;
        ...
        public void RemoveCallbacks(ITestngMapActions instance)
        {
            if (m_Wrapper.m_TestngMapActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ITestngMapActions instance)
        {
            foreach (var item in m_Wrapper.m_TestngMapActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_TestngMapActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public TestngMapActions @TestngMap => new TestngMapActions(this);
    ...
    public interface ITestngMapActions
    {
