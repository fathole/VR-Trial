...
{
    public class ODENormalModeButton : ClickableObjectBase
    {
        #region Declaration
        ...
        public void SetupElement(TMP_FontAsset fontAsset, TextContentBase.HomePage.ODENormalModeButton textContent, Action onPointerClickCallback)
        {
            // Setup Font Asset
