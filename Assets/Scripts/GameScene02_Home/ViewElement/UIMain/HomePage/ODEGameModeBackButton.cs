...
{
    public class ODEGameModeBackButton : ClickableObjectBase
    {
        #region Declaration
        ...
        public void SetupElement(TMP_FontAsset fontAsset, TextContentBase.HomePage.ODEGameModeBackButton textContent, Action onPointerClickCallback)
        {
            // Setup Font Asset
