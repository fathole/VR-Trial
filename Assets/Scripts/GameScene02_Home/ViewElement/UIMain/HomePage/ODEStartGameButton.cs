...
{
    public class ODEStartGameButton : ClickableObjectBase
    {
        #region Declaration
        ...
        public void SetupElement(TMP_FontAsset fontAsset, TextContentBase.HomePage.ODEStartGameButton textContent, Action onPointerClickCallback)
        {
            // Setup Font Asset
