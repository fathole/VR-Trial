...
{
    public class ODEDifficultyModeBackButton : ClickableObjectBase
    {
        #region Declaration
        ...
        public void SetupElement(TMP_FontAsset fontAsset, TextContentBase.HomePage.ODEDifficultyModeBackButton textContent, Action onPointerClickCallback)
        {
            // Setup Font Asset
