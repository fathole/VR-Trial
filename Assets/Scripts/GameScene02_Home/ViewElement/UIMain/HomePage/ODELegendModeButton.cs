...
{
    public class ODELegendModeButton : ClickableObjectBase
    {
        #region Declaration
        ...
        public void SetupElement(TMP_FontAsset fontAsset, TextContentBase.HomePage.ODELegendModeButton textContent, Action onPointerClickCallback)
        {
            // Setup Font Asset
