...
{
    public class ODEContinueGameButton : ClickableObjectBase
    {
        #region Declaration
        ...
        public void SetupElement(TMP_FontAsset fontAsset, TextContentBase.HomePage.ODEContinueGameButton textContent, Action onPointerClickCallback)
        {
            // Setup Font Asset
