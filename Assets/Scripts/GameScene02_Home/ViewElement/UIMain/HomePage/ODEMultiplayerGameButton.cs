...
{
    public class ODEMultiplayerGameButton : ClickableObjectBase
    {
        #region Declaration
        ...
        public void SetupElement(TMP_FontAsset fontAsset, TextContentBase.HomePage.ODEMultiplayerGameButton textContent, Action onPointerClickCallback)
        {
            // Setup Font Asset
